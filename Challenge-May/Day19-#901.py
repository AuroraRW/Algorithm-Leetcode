...
"""
# Could not use list to store all the price, because of Time Limit
# Stack of tuple
...
class StockSpanner:
    ...
    def next(self, price: int) -> int:
        result = 1
        while self.priceValue and self.priceValue[-1][0] <= price:
            result += self.priceValue[-1][1]
            self.priceValue.pop()
        self.priceValue.append((price, result))
        return result
